...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab result
...
endmodule //FP_MUL_altfp_mult_h2o
//VALID FILE
...
module FP_MUL (
	...
	FP_MUL_altfp_mult_h2o	FP_MUL_altfp_mult_h2o_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
