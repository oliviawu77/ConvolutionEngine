...
vlog -work work FP_MUL_tb.v

vsim -t ps work.FP_MUL_tb
#vsim -L $AlteraLib -L $AlteraLib1 -t ps work.top_dpram_vlg_vec_tst

view wave

add wave -binary /FP_MUL_tb/aclr
add wave -binary /FP_MUL_tb/clock
add wave -hexadecimal /FP_MUL_tb/dataa
add wave -hexadecimal /FP_MUL_tb/datab
add wave -hexadecimal /FP_MUL_tb/result
